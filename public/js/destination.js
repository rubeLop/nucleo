...
function paginator(page)
{
	$.ajax({
	  	type: "POST",
	  	url: WEB_ROOT+"/destination/ajax_paginator",
...
function modAddDestination(){
    $.ajax({
      type: "POST",
      url: WEB_ROOT+"/destination/ajax_mod_add",
      data: {type:"page"},
      beforeSend: function(){
    },	
    success: function(response) {
...
function modEditDestination(idDestination){
    $.ajax({
      type: "POST",
      url: WEB_ROOT+"/destination/ajax_mod_update",
...
$( document ).on( "submit", "#frmDestination", function() {
    return false;
})
...
$( document ).on( "click", "#btnSave", function() {
   	...
   	$.ajax({
	  	type: "POST",
	  	url: WEB_ROOT+"/destination/ajax_add",
	  	data: $("#frmDestination").serialize(true),
	  	beforeSend: function(){
...
$( document ).on( "click", "#btnUpdate", function() {
   	...
   	$.ajax({
	  	type: "POST",
	  	url: WEB_ROOT+"/destination/ajax_update",
	  	data: $("#frmDestination").serialize(true),
	  	beforeSend: function(){
        $("#stLoader_barMod").show();
        $("#stLoader_barMod").html(LOADER_BAR);
...
function delDestination(idDestination){
  if (confirm('¿Esta seguro de eliminar este elemento?')) {
      $.ajax({
      type: "POST",
      url: WEB_ROOT+"/destination/ajax_delete",
      data: {idDestination:idDestination},
      beforeSend: function(){
        $("#stLoader_bar").show();
        $("#stLoader_bar").html(LOADER_BAR);
